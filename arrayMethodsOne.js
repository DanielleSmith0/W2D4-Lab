...
// CODE HERE
const evenNumbers = mixedNumbers.filter((allNumbers, i) => {
...
const totalPrice = orders.map((num) => {
...
const bobsTotal = purchases.filter(person => person.owner === "Bob").reduce((acc, curr) => acc + curr.price, 0)
